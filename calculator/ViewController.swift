...
//  calculator
//
//  Created by s20171103192 on 2018/11/22.
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var resilt_1: UITextField!
    ...
    @IBAction func minus(_ sender: Any) {
        if add == 1{
            ...
            let a = Double(resilt_1.text!)!
            
            let b = Double(result.text!)!
            
            let c = a - b
            
            resilt_1.text = String(c)
